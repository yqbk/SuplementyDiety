...
**Najnowsze badania określają Ashwagandhę jako roślinę o właściwościach adaptogennych, dzięki zawartości substancji o działaniu farmakologicznym.** 
...
Korzenie Witani zawierają również **alkaloidy (głównie nikotynowe), fitosterole (beta-sitosterol), kumaryny, fenolokwasy (kwas chlorogenowy, przede wszystkim w zielu).** 
Dzięki dużej zawartości żelaza Ashwagandha znacznie wpływa na wzrost hemoglobiny oraz erytrocytów. 

Ashwagandha spowalnia procesy starzenia się, neutralizuje stres, wzmacnia funkcjonowanie wątroby i nerek, poprawia pamięć. Są to znakomite zioła na koncentrację, sen, uspokojenie. Reguluje także układ hormonalny, poprawia sprawność seksualną i hamuje siwienie włosów. Ponadto, zwiększa wydolność fizyczną, koordynację psychomotoryczną i zmniejsza czas reakcji - z tego powodu chętnie stosowana jest przez sportowców. 
...
Wykazano, że w grupie przyjmującej ashwagandhę poziom kortyzolu znacząco się obniżył. Jednocześnie nie odnotowano żadnych znaczących skutków ubocznych. 
...
[http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3545242/](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3545242/) 
 Celem badania było sprawdzenie wpływu Ashwagandhy na zdolności wytrzymałościowe, czyli wydolność tlenową elitarnych indyjskich rowerzystów. 

Na rowerzystach przeprowadzono test na początku i na końcu trwania eksperymentu. Sprawdzono między innymi ich VO2max oraz wskaźnik wymiany oddechowej RER. 
 Grupa eksperymentalna otrzymała 500 mg korzenia Ashwagandha dwa razy dziennie przez osiem tygodni. 
 Odnotowano znaczącą poprawę w grupie doświadczalnej, podczas, gdy w grupie placebo nie odnotowano zmian w stosunku do parametrów wyjściowych. 

Witania ospała wzmacnia układ krążenia, pomaga zwalczać anemię, ułatwia przepływ substancji odżywczych do wnętrza komórek. Ashwagandha znacząco poprawia parametry krwi. Naukowo udowodniono, że „indyjski żeń-szeń” chroni serce, przeciwdziała nadciśnieniu i chorobie wieńcowej. 
...
Ashwagandha dostępna jest na rynku zarówno w formie sproszkowanej, jak i wyciągu w postaci kapsułek. Proszek z korzenia ashwagandhy najlepiej dodać do soku lub wody (1 płaska łyżeczka dziennie - około 3g), dokładnie wymieszać i wypić. Można również dodać go do koktajlu, jogurtu czy musli. 

Dla osiągnięcia pożądanego efektu terapeutycznego Ashwagandhę należy brać przez co najmniej kilka tygodni. Niewątpliwe zaletą naturalnych specyfików jest stopniowa, lecz długotrwała poprawa stanu zdrowia. 

Ze względu na oddziaływanie na wydolność, radzenie sobie ze stresem, regulacje hormonów, wzmocnienie układu krwionośnego, poprawę parametrów krwi, ashwagandha jest suplementem polecanym sportowcom i znajduje się często w składzie suplementów kierowanych do sportowców.

### Właściwości

- wściwości przeciwbakteryjne i antynowotworowe

- obniżają ciśnienie tętnicze krwi

- silnie antyoksydacyjnie i odtruwająco

- działania przeciwstresowe i antydepresyjne. 

- Związki te wpływają na procesy zapamiętywania i kojarzenia, 

- chronią przed stresem, 

- wrzodami żołądka, 

- a także chorobą Alzheimera.

- Dzięki dużej zawartości żelaza Ashwagadha znacznie wpływa na wzrost hemoglobiny, erytrocytów i białych krwinek

---

- poprawia funkcjonowanie układu immunologiczneg

- wspomaga układ nerwowy

  - właściwości uspakajających i wyciszających

  - środek antystresowy, zwiększając tolerancję w sytuacjach napięcia nerwowego
...
– poprawia funkcję układu rozrodczego
...
### Rzeczy wspierające dietę i wyniki treningowe
- odzywki białkowe
- odzywki węglowodanowe
- aminokwasy (BCAA)

### Ekogeniki - wspieranie efektów treningowych - suplementacja sportowa
- kofeina
- arginina
- kreatyna
- sok z buraków

### Podstawowa suplementcja
- Witamina D3
  - bardzo niedoborow
  - bezpieczna w stosowaniu
  - szerokie pozytywne działanie na organizm
    - odporność
    - choroby chroniczne
    - gospodarka wapniowo-fosforanową
- Witamina K2
- Witamina A
...
### Zasada hormezy
Nadmiar cynku + niedobór miedzi -> cynk staję się toksyczny dla organizmu

### Probiotyki
- ogólne uzupełnienie flory jelitowej
- wspieranie odporności
- wpieranie wrazliwości na insulinę
- leczenie infekcji
